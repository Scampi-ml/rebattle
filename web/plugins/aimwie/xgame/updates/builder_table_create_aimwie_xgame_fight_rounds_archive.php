...
class BuilderTableCreateAimwieXgameFightRoundsArchive extends Migration
{
    public function up()
    {
        Schema::create('aimwie_xgame_fight_rounds_archive', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('aimwie_xgame_fight_rounds_archive');
    }
}
